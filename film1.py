...
#	print(rg2)
	...
	try:
		...
		print("\n !Ira keakeen dosa dadie gagal ")
		tan=input("[?] pengen download manuap beli?  (y/n) ")
		if tan.lower() == 'y':
			click.launch(info['title'][pil-1][1])
		else:
			sys.exit(" siap lanjut keun :* ")
#	print(rg3)
...
def downld2(url,judul):
	...
	if total_size != 0 and t.n != total_size:
		print("\n[Warn] Download GAGAL Rai e ira blesak sih ")
		tan=input("[?] pengen download dewek bae tah? (y/n) ")
		if tan.lower() == 'y':
			click.launch(info['title'][pil-1][1])
		else:
			sys.exit(" siap lanjutkeun :* ")
	print('\n[sip] wis ke simpen rik \n')
